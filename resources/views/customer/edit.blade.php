                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div>
                                        ...
                                        name="firstName" class="form-control" value= "{{$customer->first_name}}" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        name="middleName" class="form-control" value= "{{$customer->middle_name}}" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="block mt-1 w-full mb-2 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        name="lastName" class="form-control" value= "{{$customer->last_name}}" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        name="age" class="form-control" value= "{{$customer->age}}" required>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div>
                                        ...
                                        name="sex" class="form-control" value= "{{$customer->sex}}" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="block mt-1 w-full rounded-md shadow-sm mb-2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        name="customer_address" class="form-control" value= "{{$customer->customer_address}}" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="block mt-1 w-full rounded-md shadow-sm mb-2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        name="phone_number" class="form-control" value= "{{$customer->phone_number}}" required>
                                    </div>
